...
class Watchlist(tk.Frame):
    def __init__(self, binance_contracts: typing.Dict[str, Contract], bitmex_contracts: typing.Dict[str, Contract],
        ...
        self._binance_entry = Autocomplete(self.binance_symbols, self._commands_frame, justify=tk.CENTER,
                                           fg=FG_COLOR, insertbackground=FG_COLOR, bg=BG_COLOR_2)
        ...
        self._bitmex_entry = Autocomplete(self.bitmex_symbols, self._commands_frame, justify=tk.CENTER,
                                          fg=FG_COLOR, insertbackground=FG_COLOR, bg=BG_COLOR_2)
    ...
    def _add_symbol(self, symbol: str, exchange: str):
        ...
        self.body_widgets['symbol'][b_index] = tk.Label(self._body_frame.sub_frame, text=symbol, font=GLOBAL_FONT,
                                                        bg=BG_COLOR, fg=FG_COLOR_2, width=self._col_width)
        self.body_widgets['symbol'][b_index].grid(row=b_index, column=0)

        # Exchange

        self.body_widgets['exchange'][b_index] = tk.Label(self._body_frame.sub_frame, text=exchange, font=GLOBAL_FONT,
                                                          bg=BG_COLOR, fg=FG_COLOR_2, width=self._col_width)
        ...
        self.body_widgets['remove'][b_index] = tk.Button(self._body_frame.sub_frame, text="X",
                                                         bg="darkred", fg=FG_COLOR, font=BOLD_FONT,
