...
from interface.trades_components import TradeWatch
    ...
    def _update_ui(self):
        ...
        for client in [self.binance, self.bitmex]:
            try:
                ...
                logger.error("Error while logging through strategies dictionary: %s", e)
        ...
        try:
            ...
            logger.error("Error while logging through watchlist dictionary: %s", e)
